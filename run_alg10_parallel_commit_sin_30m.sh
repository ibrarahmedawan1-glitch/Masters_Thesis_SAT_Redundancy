...
tag="${RUN_TAG:-sin_30m_$(date +%Y%m%d_%H%M%S)}"
...
source_checkpoint="results_optimized/alg10_checkpoints_parallel_finishline_parallel_safe_20260613_132711_sin/custom_epfl_arithmetic_sin_b17da687e8a4.json"
