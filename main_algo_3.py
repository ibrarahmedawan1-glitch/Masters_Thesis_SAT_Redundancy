...
from optimizer_alg3_saf import solve_circuit
...
REPORT_FILE = os.path.join(RESULTS_BASE_DIR, f"thesis_results_ALG3_INCREMENTAL_{timestamp}.csv")
...
for i in range(1, 6): generate_random_circuit(f"{DATASET_DIR}/random_pure_{i}.aag", injection_mode='none')
...
print("[4] Running Engine (Algorithm 3: Incremental)...")
stats = []
