...
tag="${RUN_TAG:-sqrt_12h_$(date +%Y%m%d_%H%M%S)}"
...
source_checkpoint="results_optimized/alg10_checkpoints_parallel_commit_sqrt_30m_20260614_0129/custom_epfl_arithmetic_sqrt_02dcd1dab783.json"
